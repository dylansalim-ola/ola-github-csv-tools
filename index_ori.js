...
program
  ...
  .option("-x, --filterAttributes [attributes]", "Filter comma-separated list of attributes (columns) in the export.")
  .action(function (file, options) {
    co(function* () {
      ...
      console.log(options.filterAttributes)
      ...
      function (values) {
        ...
        console.log('isfile emptyb vdjhfhbueue');
        console.log(file);
        console.log(values);
        // if (file) {
        //   // This is an import!
